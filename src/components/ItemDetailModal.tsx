...
export default function ItemDetailModal({ item, onClose }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-end justify-center" onClick={onClose}>
            ...
            <div
                className="relative w-full max-w-[420px] rounded-t-[2rem] max-h-[88vh] flex flex-col animate-slide-up shadow-2xl"
            ...
            >
                ...
                <div className="overflow-y-auto w-full" style={{ flex: '1 1 auto' }}>
                    ...
                    {/* Header */}
                    <div className={`px-5 pb-2 ${item.image ? '-mt-2 relative z-10' : 'mt-2'}`}>
